...
<template>
  <header class="w-100 bg-zinc-950">
    <div class="w-full py-3 flex justify-center items-center text-sm">
      ...
      <a @click="notify" class="py-2 mx-3 px-4 border border-purple-600 rounded-md">Participar!!</a>
    </div>
    <nav class="w-full border-t border-b border-zinc-700 py-8">
      <div class="my-container mx-auto flex items-center justify-between">
        ...
        <div class="hidden md:flex space-x-6">
          <a href="#sobre" class="text-gray-500 hover:text-purple-500">Por que nós</a>
          <a href="#servicos" class="text-gray-500 hover:text-purple-500">Serviços</a>
          <a href="#portfolio" class="text-gray-500 hover:text-purple-500">Portfolio</a>
          <a href="#valores" class="text-gray-500 hover:text-purple-500">Valores</a>
          <a href="#fundador" class="text-gray-500 hover:text-purple-500">Fundador</a>
          <a href="javascript:void(0)" @click="toggleModal" class="text-gray-500 hover:text-purple-500">FQA</a>
        </div>
      ...
      <div v-if="isMenuOpen" class="md:hidden mt-4 space-y-5">
        <a href="#sobre" class="block text-gray-500 hover:text-purple-500">Por que nós</a>
        <a href="#servicos" class="block text-gray-500 hover:text-purple-500">Serviços</a>
        <a href="#portfolio" class="block text-gray-500 hover:text-purple-500">Portfolio</a>
        <a href="#valores" class="block text-gray-500 hover:text-purple-500">Valores</a>
        <a href="#fundador" class="block text-gray-500 hover:text-purple-500">Fundador</a>
        <a href="javascript:void(0)" @click="toggleModal" class="block text-gray-500 hover:text-purple-500">FQA</a>
        <a href="https://wa.me/5513981376072?text=Ol%C3%A1!%20vim%20pelo%20site%20lkmdev.com." class="block bg-purple-500 text-white mx-5 my-5 px-4 py-2 rounded hover:bg-purple-600 text-center">Vamos Conversar</a>
      </div>
    </nav>
  </header>
  <!-- Modal FAQ -->
